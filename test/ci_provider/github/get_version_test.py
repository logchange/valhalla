...
from valhalla.ci_provider.github.get_version import get_version_to_release_from_branch_name
from valhalla.version.version_to_release import ReleaseKind


class GitHubGetVersionTest(unittest.TestCase):
    ...
    @patch('os.environ.get')
    @patch('valhalla.ci_provider.github.get_version.exit')
    ...
    @patch('os.environ.get')
    @patch('valhalla.ci_provider.github.get_version.exit')
    def test_no_ref_name(self, mock_exit, mock_env_get):
        # given:
    ...
    def test_release_hotfix_branch(self, mock_env_get):
        # given:
        mock_env_get.return_value = 'release-hotfix-2.3.4'
        release_kinds = [ReleaseKind("valhalla.yml", "", "."),
        ...
        # then:
        self.assertEqual(result.version_number_to_release, '2.3.4')
    ...
    def test_no_matching_valhalla_branch(self, mock_exit, mock_env_get):
        # given:
        mock_env_get.return_value = 'release-2.3.4'
